...
@Schema(
    ...
    description = "Standard error response structure for failed API calls")
public class ApiErrorResponse {

  @Schema(description = "Application-specific error code", example = "USR_409_EMAIL")
  private String code;
  ...
  @Schema(description = "HTTP status code associated with the error", example = "409")
  private int status;
}
