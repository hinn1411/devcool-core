...
public class AuthController {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "409", description = "Conflict (username/email used)",
                            content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
    ...
    public ResponseEntity<ApiSuccessResponse<RegisterUserResponse>> register(@Valid @RequestBody RegisterUserRequest request) {
